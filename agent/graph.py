...
def market_researcher_node(state: AgentState) -> Dict[str, Any]:
    ...
    try:
        ...
        query = (
            ...
            f"Investment horizon: {prefs.get('investment_horizon', 'medium-term')}. "
...
Investment Horizon: {prefs.get('investment_horizon', 'medium-term')}
Budget Goal: {prefs.get('budget_goal', 'not specified')}
Strategy: {prefs.get('strategy', 'buy and hold')}
    ...
    try:
        ...
        final_report = {
            ...
            "investor_preferences": (
                f"Horizon: {prefs.get('investment_horizon', 'medium-term')}  |  "
                f"Strategy: {prefs.get('strategy', 'buy and hold')}  |  "
                f"Budget Goal: {prefs.get('budget_goal', 'Not specified')}"
            ),
            "disclaimer": (
